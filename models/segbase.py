...
from .base_models.resnetv1b import resnet50_v1b, resnet101_v1b, resnet152_v1b, resnet34_v1b, resnet18_v1b
...
class SegBaseModel(nn.Module):
    ...
    def __init__(self, backbone='resnet50', pretrained_base=False, dilated=False, **kwargs):
        ...
        if backbone == "resnet18": 
            self.backbone = resnet18_v1b(pretrained=pretrained_base, dilated=dilated, **kwargs)
